...
export function map_pred(o) {
    return MapLike.satisfied(o)
}
self.intern("map?", map_pred)
...
export const MapLike = define_protocol(
    self, "MapLike",
    [["-keys", [[["this"], "Get a sequence of all keys in the map"]]],
     ["-vals", [[["this"], "Get a sequence of all values in the map"]]]])
