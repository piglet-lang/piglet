...
export function conj(coll, o, ...rest) {
    ...
    if (seq_pred(coll) || seqable_pred(o)) {
        return cons(o, coll)
    }
...
export function sequential_pred(o) {
    return Sequential.satisfied(o)
}
self.intern("sequential?", sequential_pred)
...
export function print_str(o) {
    ...
    if (typeof o === 'object') {
        if(seq_pred(o)) return seq_str(o)
...
function seq_eq(self, other) {
    ...
    if (!sequential_pred(other)) return false
    let xa = first(self)
    let xb = first(other)
...
export function eq(o, ...args) {
    ...
    if (!seq_pred(o) && sequential_pred(o)) {
        o = seq(o)
    }
    if (seq_pred(o)) {
        for (const a of args) {
