...
export function find_module(pkg, mod) {
    console.log(`lang:find_module(pkg=${inspect(pkg)}, mod=${inspect(mod)})`)
...
export function ensure_module(pkg, mod) {
    console.log(`lang:ensure_module(pkg=${inspect(pkg)}, mod=${inspect(mod)})`)
...
export function resolve(sym) {
    // console.log(`lang:resolve(${inspect(sym)})`)
    assert_type(sym, Sym)
