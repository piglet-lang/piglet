...
export function eq(a, b) {
    ...
    default:
        if (eq2(a,b)) {
            for (o of Array.prototype.slice.apply(arguments, 2))
...
export function postwalk(f, o) {
    o = (Walkable.satisfied(o) ? Walkable._walk(o, (v)=>postwalk(f, v)) : o)
    if (meta(o) && WithMeta.satisfied(o)) {
        return with_meta(f(o), meta(o))
    }
    return f(o)
}
...
export function prewalk(f, i) {
    ...
    if (meta(i) && WithMeta.satisfied(o)) {
        return with_meta(o, meta(i))
    }
    return o
}
