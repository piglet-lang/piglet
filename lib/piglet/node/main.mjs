...
const {
    values: {verbose, eval: evals, import: imports, package: packages },
...
const verbosity = verbose?.length || 0
const compiler = new NodeCompiler({verbosity})
...
if (positionals.length === 0 && (!evals || evals.length === 0)) {
