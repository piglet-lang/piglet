 ...
 * executes with that binding active.
 */
...
function flatten_assignment_pair(lhs, rhs) {
  ...
  if (vector_p(lhs)) {
    ...
    //   }
    //   const arg = gensym("a")
    //   more.push(...flatten_assignment_pair(o, arg))
    //   return arg
    // })
...
class LetExpr extends ASTNode {
  ...
  static binding_scope(form, [[lhs, rhs], ...bindings], body, analyzer) {
    ...
    return analyzer.with_locals([lhs], ()=>{
      return new this(
        ...
        [new BindingScope(
          ...
          seq(bindings) ?
            [this.binding_scope(form, bindings, body, analyzer)] :
  ...
  static from(form, analyzer) {
    ...
    return this.binding_scope(form, bindings, body, analyzer)
  }
}
