...
function valid_property_name_p(n) {
            ...
            if (k instanceof Keyword) {
                ...
                for (const sym of v) {
                    push_const_binding(sym,
                                       k.name === "strs" ? list(get_qsym, as_sym, sym.name, or_dict.get(lhs))
                                       : k.name === "keys" ? list(get_qsym, as_sym, keyword(sym.name), or_dict.get(lhs))
                                       : k.name === "syms" ? list(get_qsym, as_sym, list(quote_sym, symbol(sym.name)), or_dict.get(lhs))
