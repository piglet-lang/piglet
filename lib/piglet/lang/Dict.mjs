...
// const proto_eq = (a, b) => invoke_proto("piglet:lang/Eq", "=", a, b)
// const proto_seq = (o) => invoke_proto("piglet:lang/Seq", "-seq", o)
// const proto_keys = (m) => invoke_proto("piglet:lang/MapLike", "-keys", m)
// const is_map = (o) => satisfied("piglet:lang/MapLike", o)
