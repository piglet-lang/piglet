...
export default class CodeGen {
    ...
    var_reference(node, sym) {
        ...
        //return this.member_lookup(node, [this.mksym(node, "$piglet$"), this.mksym(node, Module.munge(mod_name)), this.mksym(node, "vars"), this.mksym(node, Module.munge(sym.name)), this.mksym(node, "value")])
