...
import piglet_lang, {println, ensure_module, symbol, resolve, print_str} from "../lang.mjs"
...
export default class AbstractCompiler {
    ...
    async load(mod) {
        ...
        if(mod instanceof PrefixName) { // legacy
            this.pkg = mod.prefix ? mod.prefix : prev_mod.pkg
        ...
        const source = await this.slurp_mod(this.pkg, this.mod_name)
        await this.eval_string(source.toString())
